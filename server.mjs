...
async function serveStatic(req, res, url) {
  ...
  try {
    ...
    if (["/index.html", "/search.html", "/admin.html"].includes(pathname)) {
      ...
      const siteOptimizationScript = '<script src="/site-optimization.js?v=20260721-transfer-lock-3"></script>';
      const siteThemeStyle = '<link rel="stylesheet" href="/site-theme.css?v=20260721-transfer-lock-3">';
      const scripts = [
